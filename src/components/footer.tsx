...
export function Footer() {
  return (
    <footer className="mt-24">
      <div className="mx-auto max-w-[1360px] px-6 pb-10 sm:px-12">
        <OpsPanel />
        ...
        <p className="mt-1 flex flex-wrap items-center justify-center gap-x-5 gap-y-1 font-mono text-[11px] text-muted">
